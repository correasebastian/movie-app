describe('Home Controller', function() {
	...
	it('should rotate movies every 5 seconds', function() {
		...
		expect(HomeController.result.Title).toBe(results[0].Title);
		
		// after 5 seconds, should be next movie
		$interval.flush(5000);
		expect(HomeController.result.Title).toBe(results[1].Title);
		
		// after 5 seconds, should be next movie
		$interval.flush(5000);
		expect(HomeController.result.Title).toBe(results[2].Title);
